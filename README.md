# Generating Sankey Diagrams or Alluvial Diagrams with Python's Plotly Library 

## Click to open the Notebook directly in Google Colab
<!-- [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/bhattbhavesh91/table-question-answering-with-automatic-speech-recognition/blob/main/q-a-asr-huggingface-notebook.ipynb)
 -->
 
<a href="https://colab.research.google.com/github/bhattbhavesh91/sankey-diagram-plotly-tutorial/blob/main/sankey-diagram-notebook.ipynb" target="_blank"><img height="40" alt="Open in Colab" src = "https://colab.research.google.com/assets/colab-badge.svg"></a>

## To view the video

<table>
   <tr>
      <td><a href="http://www.youtube.com/watch?v=yyVwvBUFRwY" target="_blank"><img height="50" src = "https://img.shields.io/youtube/views/yyVwvBUFRwY?color=blue&label=Watch%20on%20YouTube&logo=youtube&logoColor=red&style=for-the-badge"></a></td>
   </tr>
</table>
...
[![sankey
](http://img.youtube.com/vi/yyVwvBUFRwY/0.jpg)](http://www.youtube.com/watch?v=yyVwvBUFRwY)
